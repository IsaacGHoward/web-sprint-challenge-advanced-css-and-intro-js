...
console.log("TASK 1 : V V V V V V")
...
//Honestly a little bit confused here. I figured I could just do artists[8].name = "Vincent Van Gogh" but it says it wants an array method?
console.log("TASK 2 : ");
...
function get20s(data){
  let validArtists = [];
  data.forEach(entry => {
    var years = entry.years.split(" - ");
    if(years[0] >= 1900 && years[0] <= 2000 && years[1] >= 1900 && years[1] <= 2000 )
      validArtists.push(entry.name);
  });
  return(validArtists);
  /* Code here */
...
console.log("TASK 6 : V V V V V V")
console.log(addArtist({id: 20, name: "Isaac Howard", years: "2000 - 2020", genre: "Web Design", nationality: "American", bio: "Just a web programming student at LambdaSchool"}));
...
function lotsOfArt(artists){
  ...
  artists.forEach(artist => {
    if(artist.paintings > 100)
      returnArtists.push(artist.name);
  });
  return(returnArtists);
}
console.log("TASK 7 : " + lotsOfArt(artists));
//missing Amedeo Modigliani because he was previously removed
...
console.log("STRETCH 2 : (Randomized Artists) V V V V V V")
